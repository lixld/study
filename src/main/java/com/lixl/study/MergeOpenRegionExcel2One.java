...
public class MergeOpenRegionExcel2One {


    static File destFile = new File("/Users/lixl/Desktop/开发区汇总.xlsx");
    ...
    public static List<Temp> readExcelfromFile(File file) {
        ...
        EasyExcel.read(file, Temp.class, new AnalysisEventListener<Temp>() {
            ...
            public void invoke(Temp student, AnalysisContext analysisContext) {
                ...
                System.out.println(student.getProvince() + " " + student.getCity() + " " + student.getRegion() + " " );
                tempList.add(temp);
    ...
    public static class Temp {
        ...
        @ExcelProperty(value = "工业园区")
        String park;

        @ExcelProperty(value = "区域面积")
        String area;

        @ExcelProperty(value = "企业数")
        String companyNumber;

        @ExcelProperty(value = "收录子园区数量")
        String sonPrakNumber;

        @ExcelProperty(value = "重点产业")
        String position;

        @ExcelProperty(value = "成立日期")
        String establishTime;

        @ExcelProperty(value = "省级")
        String provinceLevel;

        @ExcelProperty(value = "国家级")
        String countryLevel;

        @ExcelProperty(value = "管委会地址")
        String gwhAddress;

        @ExcelProperty(value = "管委会网址")
        String gwhWebUrl;

        @ExcelProperty(value = "收录子园区")
        String sonPark;
    ...
    public static void main(String[] args) {
        rewriteExcel("/Users/lixl/Desktop/开发区");
